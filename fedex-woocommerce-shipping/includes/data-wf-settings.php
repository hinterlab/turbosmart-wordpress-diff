...
return array(
	...
	'account_number'		   => array(
		'title'		   => __( 'US FedEx Account Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'meter_number'		   => array(
		'title'		   => __( 'US Fedex Meter Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'api_key'		   => array(
		'title'		   => __( 'US Web Services Key', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'api_pass'		   => array(
		'title'		   => __( 'US Web Services Password', 'wf-shipping-fedex' ),
		'type'			=> 'password',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'uk_section'		=> array(
		'title'			=> __( 'United Kingdom Section', 'wf-shipping-fedex' ),
		'type'			=> 'title',
		'description'	=> __( 'Enter the UK Fedex Details', 'wf-shipping-fedex' ),
		'class'			=>'fedex_general_tab',
	),
	'uk_account_number'		   => array(
		'title'		   => __( 'UK FedEx Account Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	),
	'uk_meter_number'		   => array(
		'title'		   => __( 'UK Fedex Meter Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'uk_api_key'		   => array(
		'title'		   => __( 'UK Web Services Key', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'uk_api_pass'		   => array(
		'title'		   => __( 'UK Web Services Password', 'wf-shipping-fedex' ),
		'type'			=> 'password',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'uk_validate_credentials' => array(
		'type'			=> 'uk_validate_button',
	),
	...
	'uk_dimension_weight_unit' => array(
			'title'		   => __( 'Dimension/Weight Unit', 'wwf-shipping-fedex' ),
			'label'		   => __( 'This unit will be passed to FedEx.', 'wf-shipping-fedex' ),
			'type'			=> 'select',
			'default'		 => 'LBS_IN',
    ...
    'uk_origin_country'    => array(
		'type'                => 'uk_single_select_country',
	),
	'uk_shipper_residential' 	=> array(
		'title'		   => __( 'Shipper Address is Residential', 'wf-shipping-fedex' ),
		'label'		   => __( 'Enable', 'wf-shipping-fedex' ),
		'type'			=> 'checkbox',
		'class'	=> 'fedex_general_tab',
	...
	'uk_shipping_payor_acc_no'	=> array(
		'title'		   => __( 'Third party Account Number', 'wf-shipping-fedex' ),
		'class'			  => 'uk_thirdparty_grp',
		'type'			=> 'text',
		'default'		 => '',
		'desc_tip'	=> true,
		'class'			  => 'uk_thirdparty_grp fedex_general_tab',
		'description'	 => 'Third Party Account Number. Required if third party payment selected',
	),
	'uk_shipping_payor_cname'	 => array(
		'title'		   => __( 'Contact Person', 'wf-shipping-fedex' ),
		'class'			  => 'uk_thirdparty_grp fedex_general_tab',
		'type'			=> 'text',
		'default'		 => '',
	...
	//shipping_payor_country
	'uk_shipp_payor_country'	=> array(
		'title'		   => __( 'Country', 'wf-shipping-fedex' ),
		'class'			  => 'uk_thirdparty_grp wc-enhanced-select fedex_general_tab',
		'type'			=> 'select',
		'default'		 => '',
		'options'		  => $country_list,
		'description'	 => 'Third Party Payer Country. Required if third party payment selected',
	...
	'uk_advanced_settings'   => array(
		'title'		   => __( 'Advanced Settings', 'ups-woocommerce-shipping' ),
		'type'			=> 'title',
		'class'			  => 'wf_general_advance_tab fedex_general_tab'
	),
	'uk_signature_option'	 => array(
		'title'		   => __( 'Delivery Signature', 'wf-shipping-fedex' ),
		'type'			=> 'select',
		'default'		 => '',
		'class'		   => 'wc-enhanced-select fedex_general_tab',
	...
	'au_section'		=> array(
		'title'			=> __( 'Australia Section', 'wf-shipping-fedex' ),
		'type'			=> 'title',
		'description'	=> __( 'Enter the Australia Fedex Details', 'wf-shipping-fedex' ),
		'class'			=>'fedex_general_tab',
	),
	'au_account_number'		   => array(
		'title'		   => __( 'Australia FedEx Account Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	),
	'au_meter_number'		   => array(
		'title'		   => __( 'Australia Fedex Meter Number', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'au_api_key'		   => array(
		'title'		   => __( 'Australia Web Services Key', 'wf-shipping-fedex' ),
		'type'			=> 'text',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'au_api_pass'		   => array(
		'title'		   => __( 'Australia Web Services Password', 'wf-shipping-fedex' ),
		'type'			=> 'password',
		'description'	 => '',
		'default'		 => '',
		'class'			=>'fedex_general_tab',
	...
	'au_validate_credentials' => array(
		'type'			=> 'au_validate_button',
	),
	...
	'au_dimension_weight_unit' => array(
			'title'		   => __( 'Dimension/Weight Unit', 'wwf-shipping-fedex' ),
			'label'		   => __( 'This unit will be passed to FedEx.', 'wf-shipping-fedex' ),
			'type'			=> 'select',
			'default'		 => 'LBS_IN',
    ...
    'au_origin_country'    => array(
		'type'                => 'au_single_select_country',
	),
	'au_shipper_residential' 	=> array(
		'title'		   => __( 'Shipper Address is Residential', 'wf-shipping-fedex' ),
		'label'		   => __( 'Enable', 'wf-shipping-fedex' ),
		'type'			=> 'checkbox',
		'class'	=> 'fedex_general_tab',
	...
	'au_shipping_payor_acc_no'	=> array(
		'title'		   => __( 'Third party Account Number', 'wf-shipping-fedex' ),
		'class'			  => 'au_thirdparty_grp',
		'type'			=> 'text',
		'default'		 => '',
		'desc_tip'	=> true,
		'class'			  => 'au_thirdparty_grp fedex_general_tab',
		'description'	 => 'Third Party Account Number. Required if third party payment selected',
	),
	'au_shipping_payor_cname'	 => array(
		'title'		   => __( 'Contact Person', 'wf-shipping-fedex' ),
		'class'			  => 'au_thirdparty_grp fedex_general_tab',
		'type'			=> 'text',
		'default'		 => '',
	...
	//shipping_payor_country
	'au_shipp_payor_country'	=> array(
		'title'		   => __( 'Country', 'wf-shipping-fedex' ),
		'class'			  => 'au_thirdparty_grp wc-enhanced-select fedex_general_tab',
		'type'			=> 'select',
		'default'		 => '',
		'options'		  => $country_list,
		'description'	 => 'Third Party Payer Country. Required if third party payment selected',
	...
	'au_advanced_settings'   => array(
		'title'		   => __( 'Advanced Settings', 'ups-woocommerce-shipping' ),
		'type'			=> 'title',
		'class'			  => 'wf_general_advance_tab fedex_general_tab'
	),
	'au_signature_option'	 => array(
		'title'		   => __( 'Delivery Signature', 'wf-shipping-fedex' ),
		'type'			=> 'select',
		'default'		 => '',
		'class'		   => 'wc-enhanced-select fedex_general_tab',
	...
	'hold_at_location'	=> array(
		'title'				=> __( 'Hold at FedEx Location', 'wf-shipping-fedex' ),
		'label'				=> __( 'Enable', 'wf-shipping-fedex' ),
		'type'				=> 'checkbox',
		'default'			=> 'no',
		'desc_tip'			=> true,
		'class'				=> 'fedex_rates_tab',
		'description'		=> __( 'Enables drop off at FedEx Location. If it is enabled and customer selected any drop off location while checkout then FedEx will hold the shipment on selected location, Customer have to pick his shipment from that location .', 'wf-shipping-fedex' ),
	),
	...
	'frontend_retun_label_reason'	  => array(
		...
		'label'				=> __( 'Allow the customer to provide the reason for return before generating a return label .', 'wf-shipping-fedex' ),
	...
	'email_content'  => array(
		'title'		   => __( 'Format of Email', 'wf-shipping-fedex' ),
		'type'			=> 'textarea',
		'class'			=> 'fedex_label_tab',
		'default'		 => '',
		'desc_tip'		   => true,
		'description'	 => __( 'Define your own email html here. Use the place holder tag [DOWNLOAD LINK] to get the label dowload link. Supported tag holders - [DOWNLOAD LINK], [ORDER NO], [ORDER AMOUNT], [PRODUCTS ID], [PRODUCTS SKU], [PRODUCTS NAME]. [PRODUCT_INFO] - Print Product details as table .', 'wf-shipping-fedex' ),
